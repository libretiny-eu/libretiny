...
PinInfo lt_arduino_pin_info_list[PINS_COUNT] = {
	...
	{PA_4,  PIN_GPIO | PIN_ADC | PIN_I2C | PIN_SWD,           PIN_NONE, 0},
	...
	{PA_8,  PIN_GPIO | PIN_I2C | PIN_I2S,                     PIN_NONE, 0},
	// D9: PA09, BOOT1, SD_CLK, I2S0_SCLK, I2C0_SCL, I2C0_SDA
	{PA_9,  PIN_GPIO | PIN_I2C | PIN_I2S,                     PIN_NONE, 0},
	// D10: PA10, SD_D0, I2S0_TX, I2C0_SCL, I2C0_SDA
	{PA_10, PIN_GPIO | PIN_I2C | PIN_I2S,                     PIN_NONE, 0},
	// D11: PA11, SD_D1, I2C0_SCL, I2C0_SDA
	{PA_11, PIN_GPIO | PIN_I2C,                               PIN_NONE, 0},
	// D12: PA12, I2C0_SCL, I2C0_SDA
	{PA_12, PIN_GPIO | PIN_I2C,                               PIN_NONE, 0},
	// D13: PB03, ADC5, I2C0_SCL, I2C0_SDA
	{PB_3,  PIN_GPIO | PIN_ADC | PIN_I2C,                     PIN_NONE, 0},
	// D14: PB04, ADC6, I2C0_SCL, I2C0_SDA
	{PB_4,  PIN_GPIO | PIN_ADC | PIN_I2C,                     PIN_NONE, 0},
	// D15: PB05, ADC7, I2C0_SCL, I2C0_SDA
	{PB_5,  PIN_GPIO | PIN_ADC | PIN_I2C,                     PIN_NONE, 0},
	// D16: PB06, I2C0_SCL, I2C0_SDA
	{PB_6,  PIN_GPIO | PIN_I2C,                               PIN_NONE, 0},
	// D17: PB07, I2C0_SCL, I2C0_SDA
	{PB_7,  PIN_GPIO | PIN_I2C,                               PIN_NONE, 0},
	// D18: PB08, UART1_RX, I2C0_SCL, I2C0_SDA
	{PB_8,  PIN_GPIO | PIN_I2C | PIN_UART,                    PIN_NONE, 0},
