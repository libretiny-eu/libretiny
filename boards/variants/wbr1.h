...
#define PINS_GPIO_MAX      18 // Last usable GPIO number
...
#define PINS_WIRE0_SCL  {2u, 11u, 15u}
#define PINS_WIRE0_SDA  {3u, 12u, 16u}
...
#define PIN_D11 0u  // PIN_A0
#define PIN_D12 1u  // PIN_A1
